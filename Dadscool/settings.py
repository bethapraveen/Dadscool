"""
Django settings for Dadscool project.
...
SECRET_KEY = 'django-insecure-*3$ik$9jxoe$w(rmf_as8fs&j%os^c=)u%-@iyqsagx(fmtdtt'
...
WSGI_APPLICATION = 'Dadscool.wsgi.application'
